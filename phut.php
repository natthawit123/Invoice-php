...
ยอด
<input name="txt1555" id="txt1" type="text" OnKeyUp="fncCal();"> <br>
จ่าย
<input name="txt2555" id="txt2" type="text" OnKeyUp="fncCal();"> <br>
ถอน  
<input name="txt3555" id="txt3" type="text" ><br>
</form>
</body>
</html>
...
if(isset($_POST['submit']))
    {
      $count = count($_POST['item_invoice']);

    
      $item_invoice	 = $_POST["item_invoice"];
      $desciption_invoice = $_POST["desciption_invoice"];
      $quantity_invoice = $_POST["quantity_invoice"];
      $price_invoice = $_POST["price_invoice"];
      $amount_invoice = $_POST["amount_invoice"];

       if ($count > 0){
        for ($i = 0; $i < $count; $i++){
          if (trim($_POST['item_invoice'][$i]) !=''){
           $sql2 = "INSERT INTO `add1`( `projact_invoice`,`item_invoice`,`desciption_invoice`,`quantity_invoice`,`price_invoice`,`amount_invoice`)
           VALUES('$projact_invoice','$item_invoice[$i]','$desciption_invoice[$i]','$quantity_invoice[$i]','$price_invoice[$i]','$amount_invoice[$i]')";
