        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="box box-primary collapse1" id="show_addmember">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action='Invoice-add-db.php' method="POST"> 
              <div class="box-body">                  
                  <div class="form-group col-md-8">
                    <label for="exampleInputEmail1">ชื่อโครงการ</label>
                    <input type="text" class="form-control"  placeholder="ชื่อโครงการ"name="projact_invoice">
                  </div>
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control"  placeholder="ชื่อลูกค้า/หน่วยงาน"name="namecus_invoice">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="exampleInputEmail1">วันที่/Date</label>
                    <input type="date" class="form-control"  placeholder="12/12/2020" name="date_invoice">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="exampleInputEmail1">เลขประจำตัวผู้เสียภาษี</label>
                    <input type="text" class="form-control"  placeholder="" name="idtax_invoice">
                  </div>
                  <div class="form-group col-md-12">
                  <label>ที่อยู่</label>
                  <textarea class="textarea form-group"  name="address_invoice" placeholder="ที่อยู่ลูกค้า" style="width: 100%; height: 100px;border: 1px solid #dddddd;"></textarea>
                   </div>    
